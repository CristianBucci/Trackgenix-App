class AdminPage {
  ...
  get btnModalConfirmCreateAdmin() {
    return $(
      '#root > div > div.modalConfirm_overlay__hepSv > div > div > span:nth-child(2) > button.button_primary__Z2ahL'
    );
  }
  ...
  get nameAdminCreated() {
    return $(
      '#root > div > div > div.Table_container__L88FC > table > tbody > tr:nth-child(12) > td:nth-child(1)'
    );
  }

  get lastNameAdminCreated() {
    return $(
      '#root > div > div > div.Table_container__L88FC > table > tbody > tr:nth-child(12) > td:nth-child(2)'
    );
  }

  get emailAdminCreated() {
    return $(
      '#root > div > div > div.Table_container__L88FC > table > tbody > tr:nth-child(11) > td:nth-child(3)'
    );
  }
